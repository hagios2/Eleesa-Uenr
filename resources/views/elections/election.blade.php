            ...
            @if (auth()->user()->policy && auth()->user()->policy->agree == 1)
                ...
                @if(auth()->user()->vote)
                    ...
                    <script>
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                text: '2020 ELEESA Presidential Elections',
                                postion: 'right'
                            },
                            legend:{
                                display:true,
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                text: '2020 ELEESA Gen. Secretary Elections',
                                postion: 'right'
                            },
                            legend:{
                                display:true,
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                text: '2020 ELEESA Parliamentary Elections',
                                postion: 'right'
                            },
                            legend:{
                                display:true,
                ...
                <div>
                    ...
                    <form method="POST" action="/elections">
                        ...
                        <div id="presidential" class="col-lg-8 col-md-6 col-sm-4">
                            ...
                            @forelse ($candidates->where('presidential', 1) as $candidate)
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <img src="{{$candidate->avatar}}" style="width:20rem; height: 18rem;" alt="" srcset=""><br>
